...
import com.example.myapplication.bookActivity.BookTime
...
class SikdangChoiceMenuAdapter(
    var context : Context,
    var sikdangList:ArrayList<SikdangListReqData>):RecyclerView.Adapter<SikdangChoiceMenuAdapter.Holder>() {
    ...
    inner class Holder (itemView: View?) : RecyclerView.ViewHolder(itemView!!){
        ...
        fun bind(position:Int){
            ...
            val sikdangListReqData = sikdangList[position]
