...
//PayPage에서 사용
class CouponData(val userId:String) {
    ...
    private fun setData(){
        ...
        val coupon4 = Coupon("12345678", 10000, 2, 78765412350, 210912, "쿠폰4")
        val coupon5 = Coupon("12345678", 0, 2, 12365412350, 210912, "쿠폰5")
   ...
   inner class Coupon(val sikdangId:String, val minPrice:Int, val overlap:Int, val couponId:Long, val couponExp:Int, val explanation:String)
}